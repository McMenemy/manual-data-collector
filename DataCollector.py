...
variablesStr = ['bedTime', 'wakeTime', 'sleepTime', 'nap', 'napTime', 'napStart', 'napEnd', 'breakfast', 'breakfastSize', 'breakfastNutrition', 'breakfastTime', 'breakfastItem', 'lunch', 'lunchSize', 'lunchNutrition', 'lunchTime', 'lunchItem', 'dinner', 'dinnerSize', 'dinnerNutrition', 'dinnerTime', 'dinnerItem', 'snack', 'snackSize', 'snackNutrition', 'snackTime', 'snackItem', 'socialEncounters', 'socialEncounterStart', 'socialEncounterTime', 'socialEncounterFun', 'socialEncounterValue', 'socialEncounterValuePerson', 'socialEncounterItem', 'exercise', 'exerciseTime', 'exerciseIntensity', 'exerciseType', 'exerciseItem', 'weed', 'weedAmount', 'alcohol', 'alcoholAmount', 'relax', 'relaxTime', 'relaxItem', 'meditate', 'meditateTime', 'sex', 'masturbation', 'fantasize', 'porn', 'plan', 'planPercent', 'toDoListItems', 'toDoListComplete', 'toDoListAdd', 'satisfaction', 'happy', 'stress', 'productivity']
variables = [bedTime, wakeTime, sleepTime, nap, napTime, napStart, napEnd, breakfast, breakfastSize, breakfastNutrition, breakfastTime, breakfastItem, lunch, lunchSize, lunchNutrition, lunchTime, lunchItem, dinner, dinnerSize, dinnerNutrition, dinnerTime, dinnerItem, snack, snackSize, snackNutrition, snackTime, snackItem, socialEncounters, socialEncounterStart, socialEncounterTime, socialEncounterFun, socialEncounterValue, socialEncounterValuePerson, socialEncounterItem, exercise, exerciseTime, exerciseIntensity, exerciseType, exerciseItem, weed, weedAmount, alcohol, alcoholAmount, relax, relaxTime, relaxItem, meditate, meditateTime, sex, masturbation, fantasize, porn, plan, planPercent, toDoListItems, toDoListComplete, toDoListAdd, satisfaction, happy, stress, productivity]
